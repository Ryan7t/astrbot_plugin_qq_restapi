...
URL Source: https://docs.astrbot.app/dev/star/guides/send-message.html
...
py`Comp.File(file="path/to/file.txt", name="file.txt") # 部分平台不支持`
...
![Image 2: 发送视频消息](https://docs.astrbot.app/assets/db93a2bb-671c-4332-b8ba-9a91c35623c2.Bmr_E62o.png)
...
![Image 3: 发送群合并转发消息](https://docs.astrbot.app/assets/image-4.hxjQYKnj.png)
